...
def main(args):
    ...
    def test_attr(args,test_dataset,modelD,net,experiment,\
        ...
        test_loader = DataLoader(test_dataset, num_workers=0, batch_size=4096)#changed here, num workers=0 instead of 1
    ...
    def train_attr(args,modelD,train_dataset,test_dataset,\
        ...
        train_loader = DataLoader(train_dataset, num_workers=0,
                batch_size=16000) # num workers = 1 earlier
    ...
    def test_fairness(dataset,args,modelD,tflogger,fairD,attribute,\
        ...
        test_loader = DataLoader(dataset, num_workers=0, batch_size=8192, collate_fn=collate_fn)
        correct = 0
        total_ent = 0
        if args.show_tqdm:
    ...
    if args.prefetch_to_gpu:
        ...
        train_loader = DataLoader(train_set, batch_size=args.batch_size, shuffle=True, drop_last=True,
                                  num_workers=0, pin_memory=True, collate_fn=collate_fn) # made change here, num workers=0, from 4
